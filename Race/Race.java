...
public class Race {
    ...
    private static boolean runRace(int L, int changingPoint, int reqTime){
        int bessieDistance = 0;
        int bessieSpeed = 0;
        boolean bessiePassed = true;
        int bessieTime = 0;
        while(true){
            bessieSpeed++;
            bessieDistance +=bessieSpeed;
            bessieTime++;
    ...
    public static void main(String[] args) throws IOException{
        ...
        InputReader input = new InputReader(new FileReader("race.in"));
